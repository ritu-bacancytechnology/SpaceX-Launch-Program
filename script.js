...
function filterYear(data,year){
    ...
    for(let i=0;i<k;i++)
    {
        ...
        var card = ' <div class="col-md-3 card-style card"><div><img src='+ img +' alt="image" style="height: 100px;width: 100px;" /></div><div><h4 class="h4">'+ name +' #'+ number +'</h4> <p>Mission Ids : </p><ul id="mission"></ul><p>Launch Year : '+ launch_year +'</p><p>Successful Launch :'+ launch_success +'</p><p>Successful Landing : Launch Landing</p></div></div>';
...
function filterSuccessLaunch(data, val){
    ...
    for(let i=0;i<k;i++)
    {
        ...
        var card = ' <div class="col-md-3 card-style card"><div class="img-div"><img src='+ img +' alt="image" style="height: 100px;width: 100px;" /></div><div><h4 class="h4">'+ name +' #'+ number +'</h4> <p>Mission Ids : </p><ul id="mission"></ul><p>Launch Year : '+ launch_year +'</p><p>Successful Launch :'+ launch_success +'</p><p>Successful Landing : Launch Landing</p></div></div>';
